...
moodArousal = visual.TextStim(win=win, name='moodArousal',
    text='Q8: How active (energetic) or passive is your current mood? For example, a sleepy person feels passive, whereas an excited person feels active.',
    font='Open Sans',
    pos=(0.0, 0.01), height=0.03, wrapWidth=1.7, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
moodDominance = visual.TextStim(win=win, name='moodDominance',
    text='Q9: How dominant would you say your current mood is? For example, although fear and anger are both active and negative, a scared person feels submissive, whereas an angry person feels dominant.',
    font='Open Sans',
