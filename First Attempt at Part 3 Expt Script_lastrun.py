...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Chris\\Documents\\Music Interestingness in the Brain\\NEWEST PsychoPy-Auditory-Attention-and-Musical-Emotions-main\\PsychoPy-Auditory-Attention-and-Musical-Emotions-main\\First Attempt at Part 3 Expt Script_lastrun.py',
...
dontAttendNote = visual.TextStim(win=win, name='dontAttendNote',
    ...
    languageStyle='LTR',
    depth=-1.0);
stimulus = sound.Sound('stimuliListNoTriggers.xlsx', secs=-1, stereo=True, hamming=True,
    name='stimulus')
...
block = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('stimuliListNoTriggers.xlsx', selection='1:15'),
...
for thisBlock in block:
    ...
    # update component parameters for each repeat
    stimulus.setSound('stimuliListNoTriggers.xlsx', secs=30.0, hamming=True)
