...
top_instr_txt = visual.TextStim(win=win, name='top_instr_txt',
    text='You will hear three music pieces at once from different directions- you will be told to focus on one of these just before they play twice. The first time they play will just be to remind you what they sound like. During the second time, there will be "oddballs" in the attended piece. These will be 2 second pitch raises; count these. Please try not to blink or move whilst the music plays.\n\nYou will be asked how many oddballs you heard. You will then have the chance to take a break.\n\nIf you have any questions at all please ask the experimenters.',
    font='Open Sans',
